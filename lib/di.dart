...
import 'package:clean_architecture_getx/features/Auth/data/repositories/auth_repository_impl.dart';
...
Future<void> init() async {
  ...
  getIt.registerFactory<SignupController>(() => SignupController(
        ...
        signinWithFacebook: getIt<SigninWithFacebook>(),
      ));
  ...
  getIt.registerLazySingleton(() => SigninWithFacebook(getIt<AuthRepository>()));
  ...
  // Authfirebase remote data sources
  getIt.registerLazySingleton<AuthDataSource>(
    () => FirebaseAuthDataSource(firebaseAuth: getIt<FirebaseAuth>()),
  );
